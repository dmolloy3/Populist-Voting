...
```{r nat-graph, out.width="100%", fig.width=9, fig.asp=.4, cache=TRUE}
...
```{r global-graph, out.width="100%", fig.width=9, fig.asp=.4, cache=TRUE}
...
```{r turnout, fig.width= 10, figure.asp = .8, out.width="100%"}
  ess.var2 <- ess.select %>%
